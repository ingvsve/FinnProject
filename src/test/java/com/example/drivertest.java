...
public class drivertest {
    ...
    public void test() {
        ...
        driver = new ChromeDriver(option); // not incognito: WebDriver driver = new ChromeDriver();
        ...
        driver.findElement(By.xpath("//button[@title='Jeg forstår']")).click(); // egen x-path
        driver.switchTo().defaultContent();

        // Enter shadow DOM to access login button in header
        WebElement element = driver.findElement(By.xpath("//finn-topbar")).getShadowRoot().findElement(By.cssSelector("header > nav > a:nth-child(5)"));
        element.click();

        // Write username and password and press log in
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(5));
        WebElement loginLink = wait.until(ExpectedConditions.elementToBeClickable(By.id("username")));
        loginLink.click();
        ...
        // Wait for "reise" to appear, then choose Gardermoen, Barcelona, dates, uncheck hotels and click on "search"
        WebDriverWait wait2 = new WebDriverWait(driver, Duration.ofSeconds(5));
        WebElement loginLink2 = wait2.until(ExpectedConditions.elementToBeClickable(By.xpath("//a[@href='/reise']")));
        loginLink2.click();
        ...
        // Choose dates
        driver.findElement(By.xpath("//input[@placeholder='Dato'][@data-testid='date-roundtrip-outbound']")).click();
        driver.findElement(By.xpath("//button[@class='button button--pill button--small absolute right-10 top-4']")).click();
        driver.findElement(By.xpath("//td[@aria-label='torsdag 9. november 2023']")).click();
        driver.findElement(By.xpath("//td[@aria-label='tirsdag 14. november 2023']")).click();
        ...
        wait3.until(ExpectedConditions.or(ExpectedConditions.attributeToBe(yourSelector, "aria-valuenow", "100"),ExpectedConditions.invisibilityOfElementLocated(yourSelector)));
